...
const UseState = () => {
  ...
  const [state, setState] = useState("Gayathri");
  ...
  return (
   ...
   <h2>2. What is UseState Hook ?</h2>
    ...
    <b>syntax:</b>  &nbsp; <font style={{fontSize: "25px"}}>const [state, setState] = useState(initialstate)</font>
    
    <h2>{state}</h2>
    <button onClick={()=> setState("D R")}>setState</button>
